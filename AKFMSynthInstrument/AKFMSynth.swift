...
public class AKFMSynthInstrument {
    ...
    init() {
        ...
        /* Here, we'll create an instance of the AKFMSynth class. You'll see 
        that we're initialiating it with a voice count of three. The number of
    ...
    /* These are the functions that will play the notes of our instrument. Each
        ...
        we want the note to play at. Try experimenting with differnet note 
